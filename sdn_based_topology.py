...
def topology():
    ...
    net = Mininet_wifi(controller = RemoteController, link=wmediumd, accessPoint =OVSKernelAP, noise_threshold=-91, fading_coefficient=3)
    ...
    cl = net.addController('cl', controller=RemoteController, ip='10.0.2.5', port =6633)
