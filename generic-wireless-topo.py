...
def topology():
    ...
    net = Mininet_wifi(controller = Controller, accessPoint =OVSKernelAP,allAutoAssociation=True)
    ...
    position = '10,20,0',active_scan=1,scan_freq="2412 2437 2462")
    sta2 = net.addStation('sta2', mac = '00:00:00:00:00:02', ip = '10.0.0.2/8',
    position = '28,30,0',active_scan=1,scan_freq="2412 2437 2462")
    sta3 = net.addStation('sta3', mac = '00:00:00:00:00:03', ip = '10.0.0.3/8',
    position = '10,40,0',active_scan=1,scan_freq="2412 2437 2462")
    sta4 = net.addStation('sta4', mac = '00:00:00:00:00:04', ip = '10.0.0.4/8',
    position = '50,40,0', active_scan=1,scan_freq="2412 2437 2462")
